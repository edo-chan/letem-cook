...
Let Em Cook is an agentic-kitchen skill that turns persistent kitchen and pantry memory into useful meal decisions. It keeps these concerns connected:
...
- six 1-10 cooking-level dimensions that control recipe-instruction detail
- inventory, purchase, cookability, and profile-aware shopping-list answers
...
Use $letem-cook to record that I drank one cup of coffee.
